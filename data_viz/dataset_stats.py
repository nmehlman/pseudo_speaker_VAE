...
def process_sample(sample_info: Dict[str, str]) -> Tuple[str, str, str]:
    """
    Process a single sample to extract age, gender, and accent.
    
    Args:
        sample_info (Dict[str, str]): Information about the sample.
    
    Returns:
        Tuple[str, str, str]: Extracted age, gender, and accent.
    """
    age = sample_info["age"]
...
if __name__ == "__main__":
    ...
    abbreviated_categories = [accent_abbreviations.get(cat, cat) for cat in categories]
